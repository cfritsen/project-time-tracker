...
export default function TimerButtons(props) {
    ...
    return (
        <div className='buttons-container'>
            <button className='button start-btn' disabled={time.active} onClick={startHandler}>Start</button>
            <button className='button stop-btn' disabled={!time.active} onClick={stopHandler}>Stop</button>
        </div>
    )
}
//--------------------------------------------